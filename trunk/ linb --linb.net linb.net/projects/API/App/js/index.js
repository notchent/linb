Class('App', 'linb.Page',{
    Instance:{
        ...
        required:["linb.UI.Layout","linb.UI.TreeBar","linb.UI.PanelBar","linb.UI.Div"],
        iniComponents:function(){
            // [[code creted by designer, don't change it manually
            this.nodes = [];

            this.mainLayout = (new linb.UI.Layout)
            .alias("mainLayout").host(this)
            .setLeft(null).setTop(null).setItems([{"id":"before","pos":"before","locked":false,"size":240,"min":100,"max":400,"hide":false,"cmd":true},{"id":"main","min":10}])
            .setType("horizontal");
            this.nodes.push(this.mainLayout.get(0));

            this.panelbar1 = (new linb.UI.PanelBar)
            .alias("panelbar1").host(this)
            .setLeft(null).setTop(null).setZIndex(1).setCaption("LINB Object Tree").setCloseBtn(false).setLandBtn(false);
            this.mainLayout.attach(this.panelbar1, 'before');

            this.objTree = (new linb.UI.TreeBar)
            .alias("objTree").host(this)
            .setLeft(0).setTop(0).setItems([])
            .afterCreated("_objtree_aftercreated").onRequestData("_objtree_onrequestdata").onItemSelected("_objtree_onitemselected");
            this.panelbar1.attach(this.objTree);

            this.divHead = (new linb.UI.Div)
            .alias("divHead").host(this)
            .setLeft(80).setTop(30).setDock("fill");
            this.mainLayout.attach(this.divHead, 'main');

            this.div21 = (new linb.UI.Div)
            .alias("div21").host(this)
            ...
            this.nodes.push(this.div21.get(0));
        ...
        _parse:function(id){
            var o = linb.SC.evalPath(id), cls, key, obj={},filter=function(s,o){
                var me=arguments.callee, h=me.h||(me.h='upper,Constructor,Before,After,prototype'.toHash(true)),
                c=s.charAt(0);
        ...
        _aftercreated:function (page, threadid) {
            ...
            linb.dom.addHeadNode('style', arr.join(''));
