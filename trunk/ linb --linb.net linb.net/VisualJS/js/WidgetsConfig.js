[
    {id:'linb.DataSource',caption:'DataSource', group:true, icon:'img/App.gif', iconPos:'-48px -48px', sub:[
        {id:'linb.DataSource.Ajax', caption:'Ajax', icon:'img/widgets.gif', iconPos:'0 top', dragable:true},
        {id:'linb.DataSource.Memory', caption:'Memory', icon:'img/widgets.gif', iconPos:'-640px top', dragable:true}
    ]},
