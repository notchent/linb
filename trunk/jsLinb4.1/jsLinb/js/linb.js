...
_.merge(linb,{
    ...
    getTheme:function(a){
        try{
            a=linb.CSS.$getCSSValue('.setting-uikey','fontFamily');
        }catch(e){}finally{
            return a||"default";
        }
    },
    setTheme:function(key, refresh, onSucess, onFail){
        ...
        if(key!=okey){
            if(refresh!==false){
                ...
                if(okey!=='default'){
                    var o=linb.CSS.get('id','theme:'+okey);
                    if(o){
                        o.disabled=true;
                        o.parentNode.removeChild(o);
                    }
                    var o=linb.CSS.$getCSSValue('.setting-uikey','fontFamily',okey);
                    if(o){
                        o.disabled=true;
                        o.parentNode.removeChild(o);
                    }
