Class("linb.coder", null,{
    ...
    Initialize:function(){
        //linb.dom.includeCSSFile(linb.getPath(this.KEY ,'/default/css.css','appearance'));
        linb.dom.addHeadNode('style',
        ...
        parse:function(str, key, paras, height, id){
            ...
            if(paras && paras[0]){
                ...
                paras.each(function(s){
                     aa.push("<a id='"+_key+"-"+s+":"+id+"' href='javascript:;' onclick='(linb.SC(\""+_this.$key+"\")).action(this,\""+s+"\");return false;'>"+s+"</a>");
                });
            ...
            aa.push(_str.replace(/</g,"&lt;").replace(/&/g,"&amp;"));
            aa.push("</pre>");
