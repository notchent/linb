    ...
    window.CONF={
        ...
        widgets: [
            ...
            {id:'linb.UI.absForm',caption:'Form Elements',group:true, image:_img_app, imagePos:'-48px -48px',sub:[
                ...
                {id:'linb.UI.RichEditor', caption:'RichEditor', image:_img_widgets, imagePos:'-128px top', dragable:true},
            ...
            {id:'linb.UI.absNavigator',caption:'Navigators',group:true, image:_img_app, imagePos:'-48px -48px', sub:[
                ...
                {id:'linb.UI.TreeView', caption:'TreeView', image:_img_widgets, imagePos:'-464px -16px', dragable:true},
