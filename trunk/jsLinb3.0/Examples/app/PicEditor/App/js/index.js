    ...
    Instance:{
        ...
        iniComponents:function(){
            ...
            host.paneMain.append((new linb.UI.Tabs)
                ...
                .setCustomStyle({"PANEL":"border-left:solid 1px #C87800;border-right:solid 1px #C87800;", "KEY":"border-bottom:solid 1px #C87800;"})
            );
        ...
        showText:function(){
            ...
            if(!(AddText=SPA.AddText)){
                ...
                SPA.AddText.getSubNode('INPUT').css({fontSize:'32px',color:'#000000',fontFamily:SPA.$fontFamily||''});
            }
        ...
        _btnaddtext_onclick:function(profile){
            ...
            SPA.request2(hash,function(){
                SPA.AddText.getSubNode('INPUT').css({fontSize:'32px',color:'#000000'});
                SPA.AddText.setLeft(0).setTop(0).setWidth(300).setHeight(100);
                SPA.ciFontSize.setValue('32',true);
                SPA.ciFontColor.setValue('#000000',true);
