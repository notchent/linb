_.set(linb.Locale,["en","app"], {
    en:'English',
    cn:'Chinese',
    apititle:"jsLINB 3.0 - API Documentation",
...
_.set(linb.Locale,["en","doc","linb"], {
    ...
    getObject:{
        $desc:"Each linb.UIProfile Object has an unique id, this function enables you to get UIProfile Object by the unique id.",
        $rtn:'linb.UIProfile',
        $paras:[
...
_.set(linb.Locale,["en","doc","linb","UI","StatusButtons"], {
    constructor:{
        $desc:"Creates a linb.UI.StatusButtons Object."
    },
    prototype:{
        getItemMargin:{
    ...
    prototype:{
        ...
        beforeIniEditor: {
            ...
            $paras:[
                "profile : linb.UIProfile.",
                "cell : Object.",
                "cellNode: linb.Dom, the cell's node"
            ],
            $snippet:[
