...
rem for adv code
rem ==================
copy %relPath%jsLinb\js\UI\FusionChartFree.js /b + %relPath%jsLinb\js\UI\FusionChart.js /b + %relPath%jsLinb\js\UI\TextEditor.js /b + %relPath%jsLinb\js\UI\TimeLine.js /b +  %relPath%jsLinb\js\UI\Poll.js /b + %relPath%jsLinb\js\UI\FoldingList.js /b + %relPath%jsLinb\js\UI\Range.js /b  + %relPath%jsLinb\js\UI\Calendar.js /b adv.js
