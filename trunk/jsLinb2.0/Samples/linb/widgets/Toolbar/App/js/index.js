    ...
    Instance:{
        ...
        iniComponents:function(){
            ...
            host.pane3.append((new linb.UI.ToolBar)
                .host(host,"toolbar5")
                .setItems([{"id":"grp1", "sub":[{"id":"a", "label":"normal button:", "caption":"button"},{"id":"b", "label":"image button:", "caption":"button",icon:'img/demo.gif'},  {"id":"c", label:"image only:",icon:'img/demo.gif' },{id:"c1",object: new linb.Template(null,'<button class=ui-btn>{caption}</button>',{caption:'from template'})}]},{"id":"grp2", "sub":[{"id":"d", label:'status button:',"caption":"status", "statusButton":true}, {"id":"e", label:'drop button:',"caption":"drop", "dropButton":true},{"split":true}, {id:'clr',object: new linb.UI.ComboInput({type:'colorpicker'})},{id:'date',object: new linb.UI.ComboInput({type:'datepicker'})}]}])
