    ...
    Instance:{
        ...
        _traceEvent:function(p) {
            ...
            if(holder){
                ...
                this.arr.push(this.$lastEvent);
        },
        _button3_onclick:function (profile, e, value) {
             this.panelbar2.getSubNode('PANEL').empty();
        }, events:{"beforeCreated":"_traceEvent", "onLoadBaseClass":"_traceEvent", "onLoadResource":"_traceEvent", "beforeIniComponents":"_traceEvent", "afterIniComponents":"_traceEvent", "onLoadReqiredClass":"_traceEvent", "onReady":"_traceEvent"}
    }
});