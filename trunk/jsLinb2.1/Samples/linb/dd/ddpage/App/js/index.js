Class('App', 'linb.Com',{
    Instance:{
        ...
        required:["linb.UI.Block", "linb.UI.Tabs", "linb.UI.ButtonViews", "linb.UI.Stacks", "linb.UI.Panel", "linb.UI.Layout", "linb.UI.Group", "linb.UI.Button", "linb.UI.Dialog", "linb.UI.Pane"], 
        ...
        iniComponents:function(){
            ...
            host.panel5.append((new linb.UI.Tabs)
                .host(host,"tabs2")
                .setItems([{"id":"aa", "caption":"itema", "tips":"item a"}, {"id":"ab", "caption":"itemb", "tips":"item b", "_w":420, "_h":128}, {"id":"ac", "caption":"itemc", "tips":"item c", "closeBtn":"true", "landBtnBtn":true}])
                .setDragKey("panel")
                .setLeft(0)
                .setTop(0)
                .setDropKeysPanel("panel")
