...
copy begin.txt /b + %libPath%jsLinb\js\linb.js /b + %libPath%jsLinb\js\Event.js /b + %libPath%jsLinb\js\CSS.js /b + %libPath%jsLinb\js\Dom.js /b  + %libPath%jsLinb\js\Com.js /b + %libPath%jsLinb\js\Cookies.js /b + %libPath%jsLinb\js\DragDrop.js /b + %libPath%jsLinb\js\ComFactory.js /b +  %libPath%jsLinb\Locale\en.js /b + end.txt /b linb.js
