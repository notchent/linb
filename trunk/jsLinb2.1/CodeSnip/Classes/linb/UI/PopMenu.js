Class('App.linb_UI_PopMenu', 'linb.Com',{
    Instance:{
        ...
        required:["linb.UI.Button", "linb.UI.PopMenu", "linb.UI.Block"], 
        ...
        iniComponents:function(){
            ...
            append((new linb.UI.PopMenu)
                .host(host,"popmenu1")
                .setItems([{"id":"itema", "caption":"itema", "tips":"item a"}, {"type":"split"}, {"id":"itemb", "type":"checkbox", value:true,"caption":"itemb", "tips":"item b"}, {"id":"itemc", "caption":"itemc", "type":"checkbox", "tips":"item c"}, {"id":"itemd", "caption":"itemd", "tips":"item d"}])
                .setShadow(false)
        ...
        _button2_onclick:function (profile, e, value) {
            this.popmenu1.pop(profile.root,2);
            this.popmenu1.$target = profile;
        }, 
        _button3_onclick:function (profile, e, value) {
            this.popmenu2.pop(profile.root,3);
