    ...
    Instance:{
        ...
        iniComponents:function(){
            ...
            append((new linb.UI.Layout)
                .host(host,"layout6")
                .setItems([{"id":"before", "pos":"before", "min":10, "size":200, "locked":false, "folded":false, "cmd":true, "hidden":false}, {"id":"main", "min":10}, {"id":"after", "pos":"after", "min":10, "size":150, "locked":false, "folded":false, "cmd":true, "hidden":false}])
                .setType("horizontal")
            );
            ...
            host.panel8.append((new linb.UI.ToolBar)
                .host(host,"toolbar10")
                .setItems([{"id":"item a", "sub":[{"id":"sub a1", "caption":""}, {"id":"sub a2", "caption":""}, {"id":"sub a3", "caption":""}, {"id":"sub a4", "caption":""}], "caption":"item a"}])
            );
            ...
            host.panel8.append((new linb.UI.TreeGrid)
                ...
                .setRows([{"cells":[{"value":"row1 col1"}, {"value":"row1 col2"}, {"value":"row1 col3"}, {"value":"row1 col4"}, {"value":""}, {"value":""}, {"value":""}], "id":"a"}, {"cells":[{"value":"row2 col1"}, {"value":"row2 col2"}, {"value":"row2 col3"}, {"value":"row2 col4"}, {"value":""}, {"value":""}, {"value":""}], "id":"b"}, {"cells":[{"value":"row3 col1"}, {"value":"row3 col2"}, {"value":"row3 col3"}, {"value":"row3 col4"}, {"value":""}, {"value":""}, {"value":""}], "sub":[["sub1", "sub2", "sub3", "sub4"]], "id":"c"}])
            );
