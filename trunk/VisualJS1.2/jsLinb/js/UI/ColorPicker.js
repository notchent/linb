    ...
    Static:{
        ...
        DataModel:{
            ...
            advance:{
                ...
                action:function(v){
                    var ns=this;
                    ns.getSubNode('ADV').display(v?'':'none');
            ...
            submitBtn:{
                ...
                action:function(v){
                    ...
                    ns.getSubNode('OK').display(n);
                    ns.getSubNode('CANCEL').display(n);
                }
            },
            $borderW:1
        },
        Appearances:{'default':{
            ...
            ADVCLR:{
                background: linb.browser.ie6?null:linb.UI.getCSSImgPara('bg.png', 'no-repeat left top'),
                _filter: linb.UI.getImgPath2('bg.png', 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="{*}",sizingMethod="crop")'),
                height:'101px',
                left:'47px',
                top:'47px',
                width:'101px'
            ...
            ADVWHEEL:{
                background: linb.browser.ie6?null:linb.UI.getCSSImgPara('clr.png', ' no-repeat left top'),
                _filter: linb.UI.getImgPath2('clr.png', 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="{*}",sizingMethod="crop")'),
                height:'195px',
                width:'195px'
            },
            'ADVMARK1, ADVMARK2':{
                background:linb.browser.ie6?null:linb.UI.getCSSImgPara('picker.png', ' no-repeat left top'),
                _filter: linb.UI.getImgPath2('picker.png', 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="{*}",sizingMethod="crop")'),
                height:'17px',
        ...
        prepareData:function(profile){
            ...
            data.submitDispay = data.submitBtn?'':'none';
        },
        EventHandlers:{
            beforeClose:function(profile, src){},
            onOK:function(profile, value){}
        },
        ...
        _updateDftTip:function(p){
            ...
            ex.setStyle({backgroundColor:'#'+p.$hex.join(''), color:p.$hsv[2]>0.6?'#000':'#FFF'});
            ex.text(p.properties.colorName);
        },
        _to3:function(s){
            if(!s)s="FFFFFF";
        ...
        _updateValueByPos:function(profile, e, flag){
            ...
            profile.boxing().updateUIValue(profile.$t_hex);
            delete profile.$hexinadv;
        },
        _prepareAdv:function(profile,e){
            var cls=this,
                pos=profile.getSubNode('ADVWHEEL').absPos();
