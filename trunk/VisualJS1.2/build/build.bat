...
rem java -jar yuicompressor.jar -o %relPath%%releasePath%%version%jsLinb/js/linb.js      --nomunge      linb.js
rem java -jar yuicompressor.jar -o %relPath%%releasePath%%version%%appname%js/index.js      --nomunge   index.js

copy linb.js %relPath%%releasePath%%version%jsLinb\js\linb.js
copy index.js %relPath%%releasePath%%version%%appname%js\index.js
